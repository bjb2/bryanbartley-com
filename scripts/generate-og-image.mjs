...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  ...
  <text x="80" y="555" font-family='${SANS}' font-size="26" fill="#6b7280">tallyhq.org · boon.gifts · delectable.guide · markets-academy</text>

  <text x="1120" y="555" text-anchor="end" font-family='${MONO}' font-size="22" fill="#6b7280">bryanbartley.com</text>
</svg>`;
